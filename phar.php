	...
	<form method="post" action="/phar-result.php" enctype="multipart/form-data">
		...
		<p>Tune the plugin using the following methods: <br>
			<input type="checkbox" name="tune_top_namespace_optimization">
				Optimize constant references by adding a <code>\</code> prefix to indicate that it is a top namespace reference.<br>
			<input type="checkbox" name="tune_obfuscation"> Obfuscate code
		</p>
		<p><font color="#8b0000">Warning: Using any of the tunes may stripe out all the comments in your code <em>except</em> PHP doc comments or line comments.</font></p>
		<p>
