...
$phar->addFromString("me.mcpe.pmt.insta.watermark", "This file is generated by mcpeme.mcpe.fun/insta/ from https://gist.github.com/" . $_REQUEST["id"] . ", build ID $identifier, at " . date(DATE_ISO8601));
$phar->stopBuffering();

if(isset($_SERVER["HTTP_ACCEPT"]) and $_SERVER["HTTP_ACCEPT"] === "application/json"){
	echo json_encode([
		"phar" => "https://mcpeme.mcpe.fun/insta/$path",
...
<p>
	...
	$lines = [
		...
		"[spoiler=\"Phar download\"][url=\"https://mcpeme.mcpe.fun/insta/$path\"]Download plugin from mcpeme.mcpe.fun[/url]",
		"Generated by [url=\"https://mcpeme.mcpe.fun/insta/\"]mcpeme.mcpe.fun Gist2Plugin instant plugin maker[/url][/spoiler]"
	];
	?>
